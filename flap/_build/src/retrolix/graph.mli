...
module Make (EdgeLabel : EdgeLabelSig) (NodeLabel : NodeLabelSig) : sig
  ...
  *)
  ...
  val add_edge : t -> NodeLabel.t -> EdgeLabel.t -> NodeLabel.t -> t (* ajoute une arete *)
  ...
  val del_edge : t -> NodeLabel.t -> EdgeLabel.t -> NodeLabel.t -> t (* supprime une arrete *)

  (** [del_node g n] returns a new graph that contains [g] minus the
      node [n] and its edges. *)
  val del_node : t -> NodeLabel.t -> t (* supprime un noeud *)
  ...
  val neighbours : t -> EdgeLabel.t -> NodeLabel.t -> NodeLabel.t list list (* retourne les voisins d'un noeud *)
