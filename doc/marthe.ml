...
(** L'analyse lexixale produit une liste de lexèmes
    à partir de la chaîne de caractères d'entrée. *)
...
let vm_init stack_size nb_variables code : machine = {
  ...
  sp                   = -1;
  code                 = code;
  variables            = Array.create nb_variables 0;
  accumulators         = Array.create nb_variables 0;
  stack                = Array.create stack_size 0;
}
